...
import { MessageSquare, ArrowUp, ArrowDown, Bookmark, Share2, TrendingUp, Clock, Users, Sparkles, Send, Image as ImageIcon, AtSign, Award, Plus, X } from "lucide-react";
      ...
      <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Share your thoughts, tips, or questions with the community. Earn +10 points!
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                placeholder="Share your thoughts, tips, or questions in detail..."
                className="min-h-[200px] resize-none"
                value={postContent}
                onChange={(e) => setPostContent(e.target.value)}
                data-testid="input-create-post-modal"
              />
            </SidebarLayout>
            <div className="flex items-center justify-between gap-4 pt-2">
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" data-testid="button-add-image-modal">
                  <ImageIcon className="h-4 w-4" />
                </Button>
                <Button variant="ghost" size="sm" data-testid="button-mention-modal">
